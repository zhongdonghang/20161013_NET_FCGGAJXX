...
namespace FrameworkUnitTest
{
    ...
    public class QQXGUnit
    {
        ...
        public void XGTestAllDevice()
        {
            ...
            //实际key请使用实际的，下面仅演示作用
            //============测试key1==============
            xgp.Access_id = 2100243222;
            //xgp.Access_Key = "ARQ4CB14Q92X";
            xgp.Secret_Key = "5a52efa224adf8cf126ff1a2022a06f3";
            //============测试key2==============
            ...
            xgp.Message = new NotifyMessage()
            {
                ...
                Content = "123有中文10%，人们有1%以及，$abcdef", //中文测试
                Vibrate = 1,
                Ring = 1,
        ...
        public void XGTestSingleDevice()
        {
            ...
            xgp.Message = new NotifyMessage()
            {
                Title = "单个 Device_token",
                Content = "测试推送单个单个 Device_token",
                Vibrate = 1
            };
            // xgp.Device_token = "e4692dfaa7a4418f4e5482fb4b8114d6515e79c5";
            xgp.Device_token = "05a84667cb1e549b42e9a64e775c08a4ba59d345";
